...
sp_oauth = SpotifyOAuth(
    ...
    client_secret='4a06103bcabf4884b428049290e20f9c',
...
def get_credentials():
    return SpotifyClientCredentials(client_id='c1e1e455737c44a5a404101c638179d8',client_secret='4a06103bcabf4884b428049290e20f9c')